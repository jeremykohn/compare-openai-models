...
| 5 | `prompt-5-implement-from-plan-and-save-discrepancies.md` | `design.md` + `implementation-plan.md` | Code changes + discrepancy reports |
...
After step 6, re-run step 5 with the remediation plan to close remaining discrepancies.
