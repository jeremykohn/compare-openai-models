...
Step 5 is execution-only: it implements open plan tasks from `implementation-plan.md` and marks completed checkboxes (`- [x]`), including tasks added by remediation.
