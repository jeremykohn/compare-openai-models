...
3. Why status code / specific error code (e.g., `code: model_not_found`) or type (e.g., `type: invalid_request_error`) is not displayed:
...
- Specific test scenarios for:
  - known typed API errors (e.g., `type: invalid_request_error`, `code: model_not_found`, `param: model`, `status: 400`, `statusText: Bad Request`)
